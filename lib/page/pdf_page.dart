...
class _PdfPageState extends State<PdfPage> {
              ...
              children: [
                ...
                ButtonWidget(
                  ...
                  onClicked: () async {
                    ...
                    shareOrOpenPdf(pdfFile.path,context);
                  },
                ),
              ],
            ),
  ...
  static Future<void> shareOrOpenPdf(String pdfPath, BuildContext context) async {
    const message = 'Check out this custom PDF!';
    final shareFile = File(pdfPath);

    if (await shareFile.exists()) {
      Share.shareFiles([pdfPath], text: message, subject: 'Custom PDF');
    } else {
      // Handle file not found or other error
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Error sharing PDF')),
      );
    }
  }
}
